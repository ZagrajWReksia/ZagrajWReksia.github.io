...
const resources = {
    en: {
        translation: {
            ...
            "mainAboutNotOfficial": "This is not an official website of the game - the author of the website has nothing to do with Aidem Media/Boombit.",
            ...
            "reksiowebsiteLink": "Original game website (<1></1>)",
            ...
            "mods": "Mods",
            "modsNotice": "Mods are not tested nor verified by the author of this website.",
            "drobLoaderDescription": "Adds loading pre-made savestates. Useful when you get stuck somewhere due to bugs that block further gameplay.",
            "alternativeSoundtrack": "Alternative soundtrack",
            "alternativeSoundtrackDescription": "Adds an alternative soundtrack created by Bartek Brosz, the creator of the original soundtrack for subsequent games. More information in the source.",
            "unusedContent": "Unused content",
            "unusedContentDescription": "A collection of patches that enables unused content (e.g., dialogues that are in the game files but are not used) and fix bugs. More details in the source.",
            "instructionsUnpackZip": "Extract the contents of the archive to the main game folder.",
            "zipArchive": "ZIP Archive",
            "instructionsRunExe": "Extract the ZIP archive and run the game by clicking on <b>{{file}}</b>",
            "instructionsLinux": "<b>Only if you use Linux</b>: Install wine, then run the game using \"linux-runner.sh\".",
            "instructionsLinuxNoRunner": "<b>Only if you use Linux</b>: Install wine, then run \"winecfg\". In Libraries tab, type \"ddraw\" in the \"New override for library\" box and click \"Add\" (patches won't work otherwise).",
            "betterInstallOther": "It is recommended to download \"{{name}}\" instead.",
            "instructionsUnpackSoundtrackReksioPiraci": "Extract the contents of the \"Reksio Piraci\" folder to the main game folder.",
            "improvedVersionWithCommunityPatchesDescription": "No-CD patch + community patches + patches for modern operating systems. Fixes known crashes, bugs that prevent game progression, eliminates graphical errors, and improves game performance.",
            "improvedVersionDescription": "No-CD patch + patches for modern operating systems.",
            "improvedVersionWithOfficialAndCommunityPatchesDescription": "No-CD patch + official patches + patches for modern operating systems. Fixes known crashes, bugs that prevent game progression, eliminates graphical errors, and improves game performance.",
            "unofficialPCPort": "Unofficial PC port",
            "unofficialPCPortDescription": "This game was ported from Android/iOS to PC by community.",
            "unofficialTranslationDescription": "Unofficial fanmade translation. Dubbing is made with AI.",
            ...
            "source": "Source",
            "credits": "Credits",
            "createdAndManagedBy": "Website created and managed by <1>Adikso</1>",
            "gamesCreatedBy": "Games created by <1>Boombit</1>",
    ...
    pl: {
        translation: {
            ...
            "mainAboutBoombit": "Firmie BoomBit (Aidem Media) wygasła licencja na wykorzystywanie postaci Reksia przez co nie są w stanie jej już sprzedawać i nie mają nic przeciwko pobieraniu gier.",
            "mainAboutNotOfficial": "To nie jest oficjalna strona gry - autor strony nie ma nic wspólnego z Aidem Media/Boombit.",
            "mainAboutMoreAboutGames": "Więcej informacji o grach z serii Przygody Reksia możesz znaleźć na:",
            "reksiopediaLink": "Reksiopedia",
            "reksiowebsiteLink": "Oryginalna strona gry",
            ...
            "mods": "Mody",
            "modsNotice": "Mody nie są przetestowane ani zweryfikowane przez autora tej strony.",
            "drobLoaderDescription": "Dodaje możliwość ładowania gotowych zapisów. Przydatne, gdy utkniesz w jakimś miejscu z powodu bugów blokujących dalszą grę.",
            "alternativeSoundtrack": "Alternatywny soundtrack",
            "alternativeSoundtrackDescription": "Dodaje alternatywny soundtrack stworzony przez Bartka Brosza - twórcy oryginalnego soundtracku do kolejnych części Przygód Reksia. Więcej informacji w źródle.",
            "unusedContent": "Niewykorzystana zawartość",
            "unusedContentDescription": "Zbiór łatek przywracających niewykorzystaną zawartość (np. dialogi które są w plikach gry, ale nie są użyte) i naprawiających bugi. Więcej szczegółów w źródle.",
            "instructionsUnpackZip": "Wypakuj zawartość archiwum do głównego folderu gry.",
            "zipArchive": "Archiwum ZIP",
            "instructionsRunExe": "<b><u>Wypakuj archiwum ZIP</u></b> i uruchom grę klikając na plik {{file}}.",
            "instructionsLinux": "<b>Tylko jeżeli używasz Linuxa</b>: Zainstaluj wine i uruchom grę poprzez \"linux-runner.sh\".",
            "instructionsLinuxNoRunner": "<b>Tylko jeżeli używasz Linuxa</b>: Zainstaluj wine i odpal \"winecfg\". W zakładce Libraries w \"New override for library\" wpisz \"ddraw\" i kliknij \"Add\" (inaczej łatki nie zadziałają).",
            "betterInstallOther": "Zaleca się zamiast tego pobranie \"{{name}}\".",
            "instructionsUnpackSoundtrackReksioPiraci": "Wypakuj zawartość katalogu \"Reksio Piraci\" do głównego katalogu gry.",
            ...
            "unofficialTranslationDescription": "Nieoficjalne tłumaczenie fanowskie. Do stworzenia dubbingu wykorzystano AI.",
            "improvedVersionWithCommunityPatchesDescription": "Łatka No-CD + łatki społeczności + łatki dla współczesnych systemów operacyjnych. Usuwa znane crashe, błędy uniemożliwiające dalszą rozgrywkę, eliminuje błędy graficzne i poprawia wydajność gry.",
            "improvedVersionDescription": "Łatka No-CD + łatki dla współczesnych systemów operacyjnych.",
            "improvedVersionWithOfficialAndCommunityPatchesDescription": "Łatka No-CD + oficjalne łatki + łatki społeczności + łatki dla współczesnych systemów operacyjnych. Usuwa znane crashe, błędy uniemożliwiające dalszą rozgrywkę, eliminuje błędy graficzne i poprawia wydajność gry.",
            ...
            "source": "Źródło",
            "credits": "Autorzy",
            "createdAndManagedBy": "Strona stworzona i zarządzana przez <1>Adikso</1>",
            "gamesCreatedBy": "Gry stworzone przez <1>Boombit</1>",
    ...
    ro: {
        translation: {
            ...
            "unofficialTranslationDescription": "Traducere neoficială făcută de fani. Dubbing is made with AI.",
