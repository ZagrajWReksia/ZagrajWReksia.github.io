...
const resources = {
    en: {
        translation: {
            ...
            "instructionsRunExe": "Extract the ZIP archive and run the game by clicking on {{file}}",
    ...
    pl: {
        translation: {
            ...
            "instructionsRunExe": "Wypakuj archiwum ZIP i uruchom grę klikając na plik {{file}}",
    ...
    ro: {
        translation: {
            ...
            "instructionsRunExe": "Extrage arhiva ZIP, apoi rulează jocul dând clic pe {{file}}",
