...
const resources = {
    en: {
        translation: {
            ...
            "mainAboutHello": "Welcome to zagrajwreksia.pl - a website created to archive all available games from Adventures of Reksio series (including their versions), so you can download them andeven  play some of them directly in your browser (via ReksioEngine).",
